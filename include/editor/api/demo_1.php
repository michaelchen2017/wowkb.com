...
if(empty($_SESSION['UserID'])) go( "/passport/admin.php?act=admin&errmsg=accessdeny&checkAuth=true&redirect=".rawurlencode( "/include/editor/api/demo_1.php" ) );
...
<html>
	...
	<form action="./demo_1.php" method="post" name="form1" id="form1">
		...
		<input type="button" id="cancel" value="取 消" onclick="self.location='./demo_1.php';"> 
	</form>
	<?php 
		}
	?>
